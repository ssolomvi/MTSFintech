package mts.animals.config_starter.abstraction;
...
public abstract class AbstractAnimal implements Animal {
    ...
    protected AbstractAnimal(String breed, String name, BigDecimal cost, String character, LocalDate birthDate) {
        if (breed == null || name == null || cost == null || character == null || birthDate == null) {
            throw new AnimalConfigurationStarterIllegalArgument("AbstractAnimal:: params must not be null");
        }
        this.breed = breed;
        this.name = name;
